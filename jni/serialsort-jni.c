 ...
 * com_ndk_DataListenerService_SerialService
 */
JNIEXPORT jobject JNICALL
Java_com_ndk_DataListenerService_SerialService_open(JNIEnv *env, jobject thiz,
...
Java_com_ndk_DataListenerService_SerialService_close(JNIEnv *env, jobject thiz) {
